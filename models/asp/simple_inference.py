...
def initialize(root_path = "/mnt/Devin/benchmark/classify/models/asp"):
    model = MLP(768)  # CLIP embedding dim is 768 for CLIP ViT L 14
    root_path = root_path
    mlp_path = os.path.join(root_path,"sac+logos+ava1-l14-linearMSE.pth")
...
if __name__ == "__main__":
    ...
    model, model2, preprocess = initialize()
